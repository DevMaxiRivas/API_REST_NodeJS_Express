...
export class UnauthorizedError extends ApiError {
    constructor(message, detail = 'You are not authorized to access this resource', source, link = null) {
        super(message, 401, 'UNAUTHORIZED', 'Unauthorized', detail, source, link
        )
    }
}
